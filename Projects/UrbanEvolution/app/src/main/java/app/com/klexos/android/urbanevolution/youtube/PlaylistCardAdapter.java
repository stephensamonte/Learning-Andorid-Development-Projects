...
import app.com.klexos.android.urbanevolution.YoutubePlayerActivity;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.mThumbnailImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //Custom YoutubePlayerActivity controls
                final Intent controlsIntent = new Intent(holder.mContext, YoutubePlayerActivity.class);
//controlsIntent.putExtra(YoutubePlayerActivity.KEY_PLAYLIST_ID, video.getId());
                controlsIntent.putExtra(YoutubePlayerActivity.KEY_VIDEO_ID, video.getId());

                holder.mContext.startActivity(controlsIntent);
            }
        });
