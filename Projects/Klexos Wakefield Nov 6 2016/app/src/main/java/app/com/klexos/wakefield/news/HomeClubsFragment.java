...
/**
 * The fragment for Wakefield Clubs twitter feeds containing a simple view.
 */
public class HomeClubsFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final TwitterListTimeline timeline = new TwitterListTimeline.Builder()
                .slugWithOwnerScreenName(getResources().getString(R.string.list_name_clubs),
