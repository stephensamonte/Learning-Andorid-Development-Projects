...
/**
 * The fragment for Wakefield Sports twitter feeds containing a simple view.
 */
public class HomeMainFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // This gets the general wakefield feed from twitter
        final TwitterListTimeline timeline = new TwitterListTimeline.Builder()
                .slugWithOwnerScreenName(getResources().getString(R.string.list_name_main),
