...
/**
 * The fragment for Wakefield Staff twitter feeds containing a simple view.
 */
public class HomeStaffFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final TwitterListTimeline timeline = new TwitterListTimeline.Builder()
                .slugWithOwnerScreenName(getResources().getString(R.string.list_name_staff),
